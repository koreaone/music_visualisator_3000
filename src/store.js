...
const state = {
  ...
  music_library: [
    {
      id: 0,
      title: "Childish Gambino - Sweatpants ft. Problem",
      filename: "Childish Gambino - Sweatpants ft. Problem.mp3",
    },
    { id: 1, title: "Mome - Aloha", filename: "Mome - Aloha.mp3" },
    { id: 2, title: "Awolation - Sail", filename: "Awolation - Sail.mp3" },
    {
      id: 3,
      title: "Cage The Elephant - Come A Little Closer",
      filename: "Cage The Elephant - Come A Little Closer.mp3",
    },
    {
      id: 4,
      title: "Drake - Back to Back",
      filename: "Drake - Back to Back.mp3",
    },
    {
      id: 5,
      title: "Hemaera - Pure Happiness 2",
      filename: "Hemaera - Pure Happiness 2.wav",
    },
    ...
    {
      id: 9,
      title: "Two Feet - Love Is A Bitch",
      filename: "Two Feet - Love Is A Bitch.mp3",
    },
    {
      id: 10,
      title: "Hans Zimmer - Interstellar",
      filename: "Hans Zimmer - Interstellar.mp3",
    },
    {
      id: 11,
      title: "PLK - Pas les mêmes",
      filename: "PLK - Pas les mêmes.mp3",
    },
    {
      id: 12,
      title: "Yellow Claw - No Class (Jordi Rivera Remix)",
      filename: "Yellow Claw - No Class (Jordi Rivera Remix).mp3",
    },
    {
      id: 13,
      title: "AREA21 - Spaceships",
      filename: "AREA21 - Spaceships.mp3",
    },
    {
      id: 14,
      title: "Lil Peep - Star Shopping",
      filename: "Lil Peep - Star Shopping.mp3",
    },
    {
      id: 15,
      title: "Mac DeMarco - My Kind Of Woman",
      filename: "Mac DeMarco - My Kind Of Woman.mp3",
    },
  ],
};
const mutations = {
  ...
  [types.INSTANCIATE_P5](state) {
    var sketch = function(p) {
      ...
      p.radialFigure_triangles_flower = function(
        maxRadius,
        offset,
        hexColor,
        grey
      ...
      p.radialFigure_triangles_rad = function(
        maxRadius,
        offset,
        hexColor,
        grey
